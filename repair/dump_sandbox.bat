...
REM python manage.py dump_object -k changes.solutioninimplementation --query "{\"implementation__user__casestudy__id\": 7}"  > repair\fixtures\sandbox_solutions.json
REM python manage.py dump_object -k changes.solutionratiooneunit --query "{\"solution__user__casestudy__id\": 7}"  > repair\fixtures\sandbox_solutionsratio.json
REM python manage.py dump_object -k changes.strategy --query "{\"user__casestudy__id\": 7}"  > repair\fixtures\sandbox_strategy.json
REM python manage.py dump_object -k publications_bootstrap.publication * > repair\fixtures\sandbox_publications.json
REM python manage.py dump_object -k studyarea.area --query "{\"adminlevel__casestudy__id\": 7}"  > repair\fixtures\sandbox_areas.json
