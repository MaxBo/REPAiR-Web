...
class EditActorTest(SeleniumBasic, unittest.TestCase):
    ...
    def test_edit_actor(self):
        ...
        driver.find_element_by_xpath("//div[@id='generic-modal']/div/div/div/div[2]/div/input").click()
        driver.find_element_by_xpath("//div[@id='generic-modal']/div/div/div/div[2]/div/input").clear()
        driver.find_element_by_xpath("//div[@id='generic-modal']/div/div/div/div[2]/div/input").send_keys("test123")
