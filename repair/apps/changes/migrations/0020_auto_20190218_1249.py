# Generated by Django 2.0 on 2019-02-18 11:49
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('affected_flow_destination', models.ForeignKey(on_delete=repair.apps.utils.protect_cascade.PROTECT_CASCADE, related_name='affected_destination', to='asmfa.Activity')),
                ('affected_flow_material', models.ForeignKey(on_delete=repair.apps.utils.protect_cascade.PROTECT_CASCADE, related_name='affected_material', to='asmfa.Material')),
                ('affected_flow_origin', models.ForeignKey(on_delete=repair.apps.utils.protect_cascade.PROTECT_CASCADE, related_name='affected_origin', to='asmfa.Activity')),
                ('affected_flow_process', models.ForeignKey(on_delete=repair.apps.utils.protect_cascade.PROTECT_CASCADE, related_name='affected_process', to='asmfa.Process')),
            ],
            options={
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('implementation_flow_destination', models.ForeignKey(on_delete=repair.apps.utils.protect_cascade.PROTECT_CASCADE, related_name='implementation_destination', to='asmfa.Activity')),
                ...
                ('implementation_flow_origin', models.ForeignKey(on_delete=repair.apps.utils.protect_cascade.PROTECT_CASCADE, related_name='implementation_origin', to='asmfa.Activity')),
        ...
        migrations.AddField(
            model_name='solutionpart',
            name='new_target',
            field=models.ForeignKey(on_delete=repair.apps.utils.protect_cascade.PROTECT_CASCADE, related_name='new_target', to='asmfa.Activity'),
        ),
        migrations.AddField(
            model_name='solutionpart',
            name='solution',
